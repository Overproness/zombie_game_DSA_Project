...
protected:
	...
	// Queue to store health items
	UArrayQueue* HealthQueue;


	// Timer for consuming health items
	FTimerHandle HealthConsumeTimer;

	void StartHealthConsumption();
